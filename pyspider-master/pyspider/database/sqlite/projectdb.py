...
class ProjectDB(SQLiteMixin, BaseProjectDB, BaseDB):
    ...
    def __init__(self, path):
        ...
        self._execute('''CREATE TABLE IF NOT EXISTS `%s` (
                ...
                base_url_pattern, seed_path, save_html,
                save_html_path, follow, domain,
                senior_url_pattern,
                xpath, depth_limit,list_url_black_pattern,
                list_url_age,seed_age,cookies,deletetime,
                ajax_crawler,ajax_url_pattern,headers,timeout,
                log_path,log_level,log_interval,lib,
                auto_file,file_path
                )''' % self.__tablename__)
