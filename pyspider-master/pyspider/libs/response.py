...
class Response(object):
    ...
    def doc(self):
        ...
        #doc.make_links_absolute(self.url.strip())
        #doc = self._doc = lxml.html.fromstring(doc.outer_html())
        elements.make_links_absolute(self.url.strip(), resolve_base_href=True)
        doc = self._doc = elements
        return doc
